...
class GoBGPTestBase(unittest.TestCase):
    ...
    # https://git.netdike/backend/gobgp2/src/issues/1682
    ...
    def test_11_rr_check_adj_rib_from_rr(self):
        ...
        # https://git.netdike/backend/gobgp2/src/issues/1630
    ...
    def test_50_rr_addpath_setup(self):
        ...
        # https://git.netdike/backend/gobgp2/src/issues/1688#issuecomment-391456615
        # https://git.netdike/backend/gobgp2/src/pull/1703
    ...
    def test_54_rr_addpath_del_route_on_vrf(self):
        # Related issue:
        # https://git.netdike/backend/gobgp2/src/issues/1688
