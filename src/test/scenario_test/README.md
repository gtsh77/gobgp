...
$ git clone https://git.netdike/backend/gobgp2/src.git
$ cd ./gobgp/test
...
```shell
$ cd $GOPATH/src/git.netdike/backend/gobgp2/src
...
1. Run all test.
    ...
    ```shell
    $ cd $GOPATH/src/git.netdike/backend/gobgp2/src/test/scenario_test
    $ ./run_all_tests.sh
    ...
    OK
