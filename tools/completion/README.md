...
1. add gobgp's path to PATH environment variable
    ...
    If you run 'go get git.netdike/backend/gobgp2/gobgp', gobgp command is installed
    in $GOPATH/bin.
...
1. load completion file
    ...
    ```bash
    % source $GOPATH/src/git.netdike/backend/gobgp2/tools/completion/gobgp-completion.bash
    ```
...
GOBGP_COMP=$GOPATH/src/git.netdike/backend/gobgp2/tools/completion/zsh
